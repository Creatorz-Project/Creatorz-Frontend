        ...
        <footer class="bg-[#150A22] rounded-lg shadow border-t-2 border-solid border-[#39294C]">
            <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                ...
                <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-400 sm:mt-0">
                    ...
                    <li>
                        <Link href="https://ayush45.notion.site/Introduction-7272d39f08614ae6b162868724e170a8" target="_blank" referrerPolicy="no-referrer" class="mr-4 hover:underline md:mr-6">Documentation</Link>
                    </li>
                    <li>
