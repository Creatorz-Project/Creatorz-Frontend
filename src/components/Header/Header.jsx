...
export default function Header() {
  ...
  return (
    <nav x-data="{ isOpen: false }" className="relative bg-[#18161c]">
      <div className="container px-2 py-2 mx-auto md:flex md:justify-between md:items-center">
        ...
        >
          ...
          {ethAccount && (
            <div>
              <button id="sdk-trigger-id" className="mx-4">
